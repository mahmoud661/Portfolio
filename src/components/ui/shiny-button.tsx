...
import { m, type AnimationProps, type HTMLMotionProps } from "framer-motion";
...
const ShinyButton = React.forwardRef<HTMLButtonElement, ShinyButtonProps>(
  ({ children, className, ...props }, ref) => {
    return (
      ...
      >
        <span
          className="relative  size-full text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)] flex justify-center items-center  text-center"
          style={{
            maskImage:
